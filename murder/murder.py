...
def get_average_sentence_length(text):
    ...
    return total_length/sentence_no
...
class TextSample:
    ...
    def __repr__(self):
        return self.author + ", with an average sentence length of " + str(self.average_sentence_length) +". \n"

def find_text_similarity(sample1, sample2):
    sentence_length_difference = percentage_difference(sample1.average_sentence_length, sample2.average_sentence_length)
    sentence_length_similarity = abs(1 - abs(sentence_length_difference))
...
print(lily_sample.author, find_text_similarity(lily_sample, murder_sample))
print(myrtle_sample.author, find_text_similarity(myrtle_sample, murder_sample))
print(gregg_sample.author, find_text_similarity(gregg_sample, murder_sample))
